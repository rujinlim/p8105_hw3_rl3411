...
In 2002, 13 states observed at 7 or more locations, which were `r pull(locate7_2002, state)`. These states continued observing at 7 or more locations in 2010, and 9 states also started observing at 7 or more locations that year, which are `r pull(compare2, state)`. 
